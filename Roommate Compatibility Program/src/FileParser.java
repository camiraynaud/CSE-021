...
public class FileParser {
	//public class for fileparser.java

	public static void main(String[] args) throws IOException {
		//public static void main with string args
		//throws IOException
		/*
		 * --------------------
		...
		//string str is equal to "my string"
		
		System.out.print("Printing String object 'str' one character at a time: ");
		//the program outprints "Printing String object 'str' one character at a time: "
		for(int i = 0; i < str.length(); i++)
			//for loop
			//int i equal to 0
			//i++ post increment value
			System.out.print(str.charAt(i));
		//program outprints this calculation of str.charAt(i)
		
		System.out.println("\n");
		//the program prints out a blank line
		
		System.out.println("ASCII value of character at position 2: " + (int)str.charAt(2));
		//program prints out this statement "ASCII value of character at position 2: " plus calculation
		System.out.println("ASCII value of character at position 4: " + (int)str.charAt(4));
		//program prints out this statement "ASCII value of character at position 4: " plus calculation
		System.out.println("Character at position 4:                " + str.charAt(4));
		//program prints out this statement "Character at position 4:                " plus calculation
		...
		if(str3 == str4) 
			//if str3 is equal to str4
			System.out.println("Reference variables str3 and str4 point to the same object");
		//program outprints this statement "Reference variables str3 and str4 point to the same object"
		String str5 = "hello";
		//string str5 is equal to "hello"
		String str6 = new String("hello");
		if(str5 == str6) 
			//if loop
			//str5 is equal to str6
			System.out.println("Reference variables str5 and str6 point to the same object");
		//program outprints "Reference variables str5 and str6 point to the same object"
		if (str5.equals(str6))
			//if loop
			//if str5.equals(str6)
			System.out.println("Reference variables str5 and str6 have the same value");
		//program outprints "Reference variables str5 and str6 have the same value"
		/*
		 * -------------
		 * READING FILES
		 * -------------
		...
		//program out prints "\nEnter the name of file to open: " and a blank line
		/*
		...
		//program outprints "Reading the file 1 line at a time ..."
		System.out.println("===========================================");
		//program outprints "==========================================="
		...
		//program outprints "Reading the entire file in one go ..."
		System.out.println("===========================================");
		//program outprints "==========================================="
		try { // TRY it out 
			Scanner input1 = new Scanner(new FileReader(filename)); 
			//scanner input 1 is equal to new scanner
			input1.useDelimiter("[\t \r]"); // Tab (\t) and/or space ( ) and/or carriage return (\r) delimited file	
			//outprint is "[\t \r]"
			while(input1.hasNext()) // Checks whether the Scanner object (input) is holding more data.
				System.out.println(input1.next()); // Print each word in file
			//system outprints the input of 1
			input1.close();
			//input 1 is closed
			System.out.println("===========================================\n");
			//program outprints "===========================================\n" and a blank line
